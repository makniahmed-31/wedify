    ...
    <section className="py-16 lg:py-20 bg-secondary/50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground">Real stories from real weddings across Tunisia</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {reviews.map((review) => {
            ...
            return (
              <div key={review.id} className="bg-card rounded-2xl border p-6 relative">
                ...
                <div className="flex items-center justify-between pt-3 border-t">
                  ...
                  {vendor && (
                    <span className="text-xs text-muted-foreground">{vendor.businessName}</span>
                  )}
                </div>
              </div>
            );
