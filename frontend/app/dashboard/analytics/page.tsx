...
import { Eye, MousePointerClick, CalendarCheck, TrendingUp, Users } from "lucide-react";
...
const STATS = [
  ...
  { label: "Clicks to Contact", value: "1,247", change: "+8.3%", icon: MousePointerClick },
  { label: "Total Bookings", value: "154", change: "+22.2%", icon: CalendarCheck },
  { label: "Conversion Rate", value: "8.4%", change: "+1.2%", icon: TrendingUp },
];
      ...
      <div className="rounded-2xl border bg-card p-6">
        ...
        <ResponsiveContainer width="100%" height={280}>
          <AreaChart data={VIEWS_DATA}>
            ...
            <Area type="monotone" dataKey="views" stroke="#C9A84C" strokeWidth={2} fill="url(#goldGrad)" name="Views" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
        ...
        <div className="rounded-2xl border bg-card p-6">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <BarChart data={VIEWS_DATA}>
              ...
              <Tooltip contentStyle={{ borderRadius: "12px", border: "1px solid hsl(var(--border))", backgroundColor: "hsl(var(--card))" }} />
              <Bar dataKey="bookings" fill="#C9A84C" radius={[6, 6, 0, 0]} name="Bookings" />
            </BarChart>
          </ResponsiveContainer>
        </div>
