...
const SEO_CHECKS = [
  { label: "Meta Title", status: "good", message: "Your meta title is 58 characters — ideal length." },
  { label: "Meta Description", status: "warning", message: "Meta description is 124 characters. Aim for 150–160." },
  { label: "Business Name", status: "good", message: "Business name is set." },
  { label: "Category Keywords", status: "good", message: "Category page linked correctly." },
  { label: "Gallery Images", status: "error", message: "No alt text on gallery images. Add descriptions." },
  { label: "Phone Number", status: "good", message: "Phone number is visible on your profile." },
  { label: "City / Location", status: "good", message: "City is set to Tunis." },
  { label: "Schema Markup", status: "good", message: "LocalBusiness schema is auto-generated." },
  { label: "Reviews Count", status: "warning", message: "You have 128 reviews. More reviews = better ranking." },
  { label: "Response Time", status: "good", message: "Responding within 1 hour boosts your ranking." },
];
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Optimize your profile to rank higher in search results.</p>
      </div>
      ...
      <div className="rounded-2xl border bg-card p-6 flex items-center gap-6">
        <div className="relative w-24 h-24 shrink-0">
          <svg className="w-24 h-24 -rotate-90" viewBox="0 0 100 100">
            <circle cx="50" cy="50" r="40" stroke="hsl(var(--muted))" strokeWidth="12" fill="none" />
            <circle
              cx="50" cy="50" r="40"
              stroke="#C9A84C"
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm mb-3">Your profile is well-optimized. Fix remaining issues to reach 100.</p>
          <div className="flex gap-4 text-sm">
            <span className="text-green-600 font-medium">{good} Good</span>
            <span className="text-yellow-600 font-medium">{warnings} Warnings</span>
      ...
      <div className="rounded-2xl border bg-card p-6 space-y-5">
        ...
        <div>
          ...
          />
          <p className="text-xs text-muted-foreground mt-1">124/160 characters</p>
        </div>
        <div>
