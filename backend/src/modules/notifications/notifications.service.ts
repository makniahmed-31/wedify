...
import { SendNotificationDto, NotificationResponseDto, NotificationChannel } from './dto/notification.dto';
...
export class NotificationsService {
  ...
  async getMyNotifications(userId: string, unreadOnly = false): Promise<NotificationResponseDto[]> {
  ...
  private async dispatchToChannel(channel: NotificationChannel, dto: SendNotificationDto): Promise<void> {
    switch (channel) {
