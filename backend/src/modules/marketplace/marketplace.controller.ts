...
export class MarketplaceController {
  ...
  @Public()
  @Get('homepage')
  @ApiOperation({ summary: 'Get homepage data: featured, top-rated, new vendors and categories' })
  getHomepage() {
  ...
  @Public()
  @Get('rankings')
  @ApiOperation({ summary: 'Get vendor rankings with subscription-boosted scoring' })
  ...
  getCategoryPage(@Param('category') category: string, @Query('city') city?: string) {
