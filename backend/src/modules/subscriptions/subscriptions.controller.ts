import {
  Controller, Get, Post, Put, Delete, Body, UseGuards, HttpCode, HttpStatus, Param,
} from '@nestjs/common';
import { ApiTags, ApiOperation, ApiBearerAuth } from '@nestjs/swagger';
import { SubscriptionsService } from './subscriptions.service';
import { CreateSubscriptionDto, SubscriptionPlan } from './dto/subscription.dto';
...
export class SubscriptionsController {
  ...
  @Public()
  @Get('plans')
  @ApiOperation({ summary: 'Get all available subscription plans and features' })
  getPlans() {
