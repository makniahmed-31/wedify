...
export class SeoController {
  ...
  @Roles('VENDOR')
  @Get('score')
  @ApiOperation({ summary: '[Vendor] Get my SEO score and improvement recommendations' })
  ...
  @Roles('VENDOR')
  @Put('meta')
  @ApiOperation({ summary: '[Vendor] Update SEO meta title, description, and slug' })
  ...
  @Roles('ADMIN')
  @Put('recalculate')
  @ApiOperation({ summary: '[Admin] Trigger batch SEO score recalculation for all vendors' })
  recalculateAll() {
