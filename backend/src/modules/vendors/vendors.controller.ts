...
import { CreateVendorProfileDto, UpdateVendorProfileDto } from './dto/vendor.dto';
...
export class VendorsController {
  ...
  findAll(
    ...
    return this.vendorsService.findAll({ category, city, minPrice, maxPrice }, page, limit);
  }
  ...
  uploadMedia(@CurrentUser() user: any, @UploadedFiles() files: Express.Multer.File[]) {
